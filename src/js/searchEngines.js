let searchEngines = {
    list: [{ 'name': 'google', 'url': 'https://www.google.com/search?newwindow=1&q=', 'href': 'https://www.google.com/ncr/' },
    { 'name': 'googlehk', 'url': 'https://www.google.com.hk/search?q=', 'href': 'https://www.google.com.hk/ncr/' },
    { 'name': 'baidu', 'url': 'https://www.baidu.com/s?wd=', 'href': 'https://www.baidu.com/' }, {
        'name': 'MDN',
        'url': 'https://developer.mozilla.org/zh-CN/search?q=',
        'href': 'https://developer.mozilla.org/zh-CN/'
    },
    { 'name': 'bilibili', 'url': 'http://search.bilibili.com/all?keyword=', 'href': 'http://search.bilibili.com/' },
